//
// CharacterSelectPage.xaml.cpp
// Implementation of the CharacterSelectPage class
//
...
void CharacterSelectPage::LoadState(Object^ navigationParameter, IMap<String^, Object^>^ pageState)
{
